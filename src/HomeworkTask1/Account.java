...
public class Account {
  ...
  public boolean equals(Object obj) {
    ...
    // пытаемся Object obj из 66-й строки превратить в HomeworkTask1.Account other
    // пытаемся сделать что-то вроде `HomeworkTask1.Account other = obj`, но безопасно
    if (! (obj instanceof Account other)) { // если obj - не HomeworkTask1.Account или его потомок, а что-то ещё
      return false; // с "какими-то" объектами мы не сравниваем - очевидно, они не совпадают
    }
    // дальше мы сравниваем HomeworkTask1.Account this и HomeworkTask1.Account other из 72-й строки
